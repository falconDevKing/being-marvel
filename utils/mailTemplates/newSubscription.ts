const NewSubscriptionMailTemplate = (email: string) => {
  return `<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    >
      ...
      <tr>
        <td style="background: linear-gradient(180deg, rgba(16, 25, 136, 0.2) 0%, rgba(68, 205, 224, 0.2) 100%); padding: 48px 42px; border-radius: 10px">
          <p style="font-weight: 700; font-size: 24px; line-height: 32px; color: #253858">New Subscription</p>
        </td>
      </tr>
      <tr>
        <td style="padding: 40px; line-height: 32px; font-size: 16px; color: #253858; font-style: normal; font-weight: 400">
          ...
          <p>Kindly do well to reach out to the person in due time and show some love.</p>
...
export default NewSubscriptionMailTemplate;
