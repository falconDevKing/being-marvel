...
const PrivacyPolicy = () => {
  const { title, date, intro, footer, sections } = privacyPolicyData;

  return (
    <>
      <Head>
        <title>Privacy Policy | Being Marvel</title>
        <meta property="og:title" content="Privacy Policy | Being Marvel" />
        <meta
          name="description"
