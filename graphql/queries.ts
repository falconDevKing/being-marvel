...
`;
export const fetchPostByTitleLink = /* GraphQL */ `
  query FetchPostByTitleLink(
    ...
    fetchPostByTitleLink(customLink: $customLink, id: $id, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {
      items {
        id
        category
        title
